...
# paths
yaml_path = os.path.join(mydir,'../../../WT_Ontology/IEA-15-240-RWT_VolturnUS-S.yaml')  # yaml file with data
ed_path = os.path.join(mydir,'../../../OpenFAST/IEA-15-240-RWT-UMaineSemi/IEA-15-240-RWT-UMaineSemi_ElastoDyn_tower.dat')  # elastodyn file
h2_st_path = os.path.join(mydir,'../data/IEA_15MW_RWT_UMaineSemi_Tower_st.dat')  # file to write for HAWC2 model
