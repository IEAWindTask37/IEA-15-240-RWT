------- OpenFAST INPUT FILE -------------------------------------------
NREL 15 MW Offshore Reference Turbine, preliminary OpenFAST model for design iteration version 4.0, 9/30/2019
---------------------- SIMULATION CONTROL --------------------------------------
...
0                      CompIce     - 
---------------------- INPUT FILES ---------------------------------------------
"NREL15mw_OpenFAST_prelim_v4_ElastoDyn.dat"  EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"NREL15mw_OpenFAST_prelim_v4_InflowFile.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"NREL15mw_OpenFAST_prelim_v4_AeroDyn15.dat"  AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"NREL15mw_OpenFAST_prelim_v4_ServoDyn.dat"   ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
