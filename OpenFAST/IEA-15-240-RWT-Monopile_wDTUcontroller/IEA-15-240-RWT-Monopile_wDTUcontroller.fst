...
"../IEA-15-240-RWT-Monopile/IEA-15-240-RWT-Monopile_AeroDyn15.dat"  AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"IEA-15-240-RWT-Monopile_ServoDyn_wDTUcontroller.dat"   ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
"../IEA-15-240-RWT-Monopile/IEA-15-240-RWT-Monopile_SeaState.dat"                 SeaStFile   - Name of file containing sea state input parameters (quoted string)
