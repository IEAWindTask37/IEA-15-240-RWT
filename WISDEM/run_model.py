...
fname_input = "IEA-15-240-RWT_FineGrid" if fine_grid_flag else "IEA-15-240-RWT"
fname_wt_input = os.path.join(ontology_dir, fname_input+".yaml")
...
towdata = np.c_[htow,
                prob['towerse.tower_outer_diameter'],
                np.r_[prob['towerse.tower_wall_thickness'][0], prob['towerse.tower_wall_thickness']]]
rowadd = []
...
towDF['Mass Density [kg/m]'] = prob['towerse.rho'][0] * A
towDF['Fore-aft inertia [kg.m]'] = towDF['Side-side inertia [kg.m]'] = towDF['Mass Density [kg/m]'] * I/A
towDF['Fore-aft stiffness [N.m^2]'] = towDF['Side-side stiffness [N.m^2]'] = prob['towerse.E'][0] * I
towDF['Torsional stiffness [N.m^2]'] = prob['towerse.G'][0] * 2*I
towDF['Axial stiffness [N]'] = prob['towerse.E'][0] * A
...
overview['RNA mass [t]'] = prob['drivese.rna_mass']
overview['Tower mass [t]'] = prob['towerse.tower_mass']
...
overview['Monopile mass [t]'] = prob['towerse.monopile_mass']
...
# Edit RNA properties spreadsheet
